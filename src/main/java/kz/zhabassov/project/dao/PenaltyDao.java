...
public class PenaltyDao implements InitializingBean {
    ...
    public Penalty insert(Penalty penalty) {
        ...
        if (status != 0) {
            ...
            penalty = null;
            log.warn("Penalty didn't insert with name ");
        }
        return penalty;
    }
    ...
    public Penalty update(Penalty penalty) {
        ...
        if (status != 0) {
            ...
            penalty = null;
            log.warn("No Penalty found with name ");
        }
        return penalty;
    }

    public String delete(String penalty) {
    ...
    public Penalty findByPenalty(String penaltyName) {
        ...
        if (penalty != null) {
            ...
            penalty = null;
            log.warn("Couldn't find penalty with penalty name ");
        }
        return penalty;
    }

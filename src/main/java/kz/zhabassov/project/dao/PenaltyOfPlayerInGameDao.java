...
public class PenaltyOfPlayerInGameDao implements InitializingBean {
    ...
    private static final String COLUMN_PENALTY_PLAYER_GAME_ID = "player_penalty_game_id";
    ...
    public PenaltyOfPlayerInGame insert(PenaltyOfPlayerInGame penaltyOfPlayerInGame) {
        ...
        if (status != 0) {
            ...
            penaltyOfPlayerInGame = null;
            log.warn("PenaltyOfPlayerInGame didn't insert of player, penalty and game ID ");
        }
        return penaltyOfPlayerInGame;
    }

    public PenaltyOfPlayerInGame update(PenaltyOfPlayerInGame penaltyOfPlayerInGame) {
        SqlParameterSource namedParameters = new MapSqlParameterSource().addValue(COLUMN_PENALTY, penaltyOfPlayerInGame.getPenalty()).addValue(COLUMN_PENALTY_PLAYER_GAME_ID, penaltyOfPlayerInGame.getPenaltyOfPlayerInGameId());
        ...
        if (status != 0) {
            ...
            penaltyOfPlayerInGame = null;
            log.warn("No PenaltyOfPlayerInGame found with name ");
        }
        return penaltyOfPlayerInGame;
    }

    public int delete(int penaltyOfPlayerInGameId) {
        ...
        if (status != 0) {
            ...
            penaltyOfPlayerInGameId = 0;
            log.warn("No PenaltyOfPlayerInGame found with ID ");
        }
        return penaltyOfPlayerInGameId;
